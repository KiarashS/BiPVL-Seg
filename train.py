    ...
    if (epoch + 1) % val_interval == 0:
        ...
        with torch.no_grad():
            for val_data in tqdm(val_loader):
                ...
                val_outputs = sliding_window_inference(inputs = val_inputs, roi_size = (96, 96, 96), sw_batch_size = 1, predictor = model, 
